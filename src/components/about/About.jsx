...
function About() {
  return (
    <div className="aboutPage h-full w-full flex flex-col items-center p-1.5 gap-3 bg-transparent">
      <h1 className="text-3xl text-amber-50 font-bold border-amber-50 border-b-2 roboto  ">
        About Me
      </h1>
      <div className="content h-full w-full flex  justify-center items-center ">
        ...
        >
          ...
          <div className="card1 h-[20vh] w-[35vw] bg-[#f1e9e9ea] rounded-l-2xl backdrop-blur-2xl ">
          ...
          <div className="card1 h-[20vh] w-[40vw]  bg-[#f1e9e9ea]  rounded-l-2xl  hover:shadow-2xl ">
            <h1 className="text-2xl p-4 font-semibold flex gap-10 ">
